    ...
    <>
      <Card className="border-destructive/30">
        <CardHeader>
          ...
          <CardDescription>
            Удаление аккаунта безвозвратно. Будут удалены профиль, вакансии, заявки (включая заявки
            других пользователей на ваши вакансии), пресеты поиска, подписка и прочие данные в
            сервисе. Неиспользованные оплаченные токены отклика и удерживаемое эскроу будут
