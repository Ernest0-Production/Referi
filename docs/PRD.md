...
- После отправки пользователь видит подтверждение (toast); ссылка для связи с модерацией вне приложения — в настройках (`/dashboard/settings`), если задана `NEXT_PUBLIC_MODERATION_CONTACT_URL`.
