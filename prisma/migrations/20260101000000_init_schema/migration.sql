...
-- CreateEnum
CREATE TYPE "Specialty" AS ENUM ('FRONTEND', 'BACKEND', 'FULLSTACK', 'IOS_MOBILE', 'ANDROID_MOBILE', 'DEVOPS', 'QA', 'DATA', 'ML_AI', 'SECURITY', 'OTHER');

-- CreateEnum
CREATE TYPE "Grade" AS ENUM ('JUNIOR', 'MIDDLE', 'SENIOR', 'LEAD', 'PRINCIPAL');
