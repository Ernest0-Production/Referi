...
| `vacancies.applicants` | query    | isAuth | `{ vacancyId }`                                                                                                                                       | Список заявок на свою вакансию (только контакты, bio, cover); в UI — блок кандидатов на `/vacancies/[id]` для автора рефералки                                                                                                                                                     |
