...
| ID      | Описание                                                                                                                                                                                           |
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **G1**  | Соискатель аутентифицирован. Роль включает `SEEKER`.                                                                                                                                               |
...
**Side effects отдельно от транзакции**: вызовы внешних сервисов (ЮКасса, Telegram) происходят после успешного коммита транзакции. При сбое внешнего сервиса — повтор через BullMQ.
