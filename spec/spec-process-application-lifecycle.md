...
**Назначение**: исчерпывающее описание жизненного цикла заявки соискателя от момента отправки запроса по рефералке до терминального состояния.
...
| `refundedByCancelAck / Auto`   | Инициировать возврат; освободить слот активной заявки                                                       |
