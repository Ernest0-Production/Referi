...
| ------------------------------------ | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NEXT_PUBLIC_MODERATION_CONTACT_URL` | Нет          | HTTPS- или другая ссылка на открытый контакт (например `https://t.me/username`). Встраивается в настройках (`/dashboard/settings`), если задана. |
